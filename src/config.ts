...
export const siteConfig: SiteConfig = {
  title: "pinzhen0910",
  subtitle: "Huang, Pin-Chen's Blog",
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: "GitHub",
      url: "https://github.com/Alena0910", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    },
    {
      ...
      url: "https://github.com/Alena0910",
    },
  ],
};
